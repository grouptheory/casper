...
<body bgcolor="#FF9949"><br>
  ...
  <form method="post" action="processPASSWORDgenerate.php" name="generatePASSWORD">
    <br>

    <table cellspacing="10" cellpadding="6" width="600" bgcolor="#FFFF99" align="center">
      <caption>
        <font color="#000066" size="4">Generate Section Passwords</font>
      </caption>
...
?>
 ...
 <tr>
    <td align="center"><input type="submit" name="submitbutton"
        value="Generate the passwords" disabled="true">
    </td>
 </tr>
