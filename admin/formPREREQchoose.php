...
<body bgcolor="#FF9949">
  <a name="(top)"></a><br>
  <form method="post" action="processPREREQchoose.php" name= "addPREREQ">
    <br>
    <table cellspacing="0" cellpadding="10" width="550" bgcolor="#FFFF99" align="center">
       <caption>
         <font color="#000066" size="4">Edit Course Prerequisites</font>
       </caption>
       <tr>
         <td align="center">
            <fieldset style=
            "border-width:0; background:#FFCC49; width:400">
              <table width="100%">
                <?php
                include("connect.php");
